...
==== Setting up of a persistent volume for running pipelines
...
If you are not running your openshift cluster on public cloud, you can setup the persistent volume statically. For example on the usage of static persistent volume provisioning you can go https://github.com/kabanero-io/kabanero-pipelines/blob/master/pipelines/docs/VolumeProvisioning.md#static-persistent-volumes[here]

===== Dynamic Volume Provisioning

If you are running your openshift cluster on a public cloud, you can take advantage of dynamically provisioning the persistent volume.You can use your cloud provider’s default storage class for it. For example on the usage of dynamic persistent volume provisioning you can go https://github.com/kabanero-io/kabanero-pipelines/blob/master/pipelines/docs/VolumeProvisioning.md#dynamic-volume-provisioning[here]
