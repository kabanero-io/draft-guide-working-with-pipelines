...
The tasks & pipelines provided in the [Kabanero pipelines events directory](https://github.com/kabanero-io/kabanero-pipelines/tree/master/pipelines/incubator/events) are geared to work with the Kabanero events operator.  <TODO: Link to events operator here.>.  There are 4 primary pipelines provided here to help illustrate the following work flows.
